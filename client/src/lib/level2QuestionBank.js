// Client mirror of server/src/data/level2QuestionBank.js — same reasoning as
// lib/questionBank.js mirroring the main bank: QuestionRunner grades locally first
// (offline-friendly), then the raw attempts are sent to POST .../level2-submit for
// authoritative re-grading. Keep this in sync with the server copy by hand; it's
// small and changes rarely, same as questionBank.js already is.
